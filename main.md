...
# 要旨
宇宙農場における重力について考察し、バルーン形状のモジュール型水耕栽培装置に対する人工重力の影響を主に材料力学の観点から計算する。
...
先行研究として、バルーン形状のモジュール型水耕栽培装置「メタルネットバルーンプラント」(以下、MNBP) \[busyoucow/spacefarm\] があり、この装置をベースにして本記事を展開していく。

まずは、植物栽培に致命的な影響を与えない重力の大きさを考察し、MNBP の強度を計算する。そのうえで輸送コストなども算出する。

# 植物栽培における重力の大きさ
> 0.38g 環境では，根の細胞の増殖速度，大きさは 1g 環境と比較して有意な差異は認められなかった。
- **from** [BSJ-Review11A_83-89](https://bsj.or.jp/jpn/general/bsj-review/BSJ-Review11A_83-89.pdf)
  - **from** Manzano, A., Herranz, R., den Toom, L.A., te Slaa, S., Borst, G., Visser, M., Javier Medina, F. & von Loon, J.J.W.A. 2018. Novel, Moon and Mars, partial gravity simulation paradigms and their effects on the balance between cell growth and cell proliferation during early plant development. npj Microgravity 9: 1-11.
